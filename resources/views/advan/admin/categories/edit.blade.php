...
<div class="modal fade modal-lg" id="edit-category" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            id="category-form"
              method="post"
             {{-- action="{{ route("admin.categoryUpdate") }}"

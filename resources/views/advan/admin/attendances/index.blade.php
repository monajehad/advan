    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="title title-color purple">
            ...
            <div class="card-toolbar">
                {{-- @can('users-add') --}}
                {{-- <a id="add_button" class="btn btn-primary font-size-sm ml-3" href="{{ route('admin..create') }}">
                ...
                {{-- @endcan --}}
                <a href="{{route('admin.attendances.export.excel')}}" class="btn btn-info mx-1 font-size-sm"
                id="export-button">
                <span class="svg-icon svg-icon-md svg-icon-2x">
        ...
        <div class="card-body py-0">
            ...
            <div class="attendance-table-body">
               ...
               @includeIf('advan.admin.attendances.table-data')
...
function load_data_table(page = '') {
        $.ajax({
            url: '{{url("admin/attendances/")}}?page=' + page,
            data: {
                search: $('#search_input').val()
            },
            type: "get",
            success: function(response) {
                $('.attendance-table-body').html(response.attendances)
...
$(document).on('click','.delete-attendance',function(){
            ...
            Swal.fire({
                title: 'هل أنت متأكد من حذف  الحضور',
                showDenyButton: true,
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: '{{route("admin.attendances.delete")}}' ,
                        type: "POST",
                        data: {id:id},
                        success: function( response ) {

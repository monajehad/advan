...
<div class="modal fade modal-lg" id="add_button" tabindex="1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
                    ...
                    <div class="accordion" id="accordionExample">
                        <div class="card">
                            <div class="card-header" id="headingOne">
                                <h2 class="mb-0">
                                    <button class="btn btn-light btn-block text-right" type="button"
                                        data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
                                        aria-controls="collapseOne">
                                            اضافة بيانات الشخصية
                                    </button>
                                </h2>
                            </div>
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                ...
                                <form class="form" id="form" method="POST" action="{{ route("admin.clients.store") }}"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <!--begin: Wizard Step 1-->
                                    <div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
                                        
                                        <div class="image-input image-input-outline image-input-circle align-center"
                                            id="kt_image_3">
                                            ...
                                            <label
                                                ...
                                                data-original-title="تعديل الصورة">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select
                                                class="form-control pl-0 pb-0 pt-0 {{ $errors->has('specialty') ? 'is-invalid' : '' }}"
                                                name="specialty_id" id="specialty_id" required>
                                                @foreach($specialties as $id => $entry)
                                                <option value="{{ $id }}"
                                                    {{ old('specialty_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                                </option>
                                                @endforeach
                                            </select>
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}"
                                        type="text" name="mobile" id="mobile" value="{{ old('mobile', '') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('jobId') ? 'is-invalid' : '' }}"
                                        type="text" name="jobId" id="jobId" value="" required>
                                    @if($errors->has('jobId'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('jobId') }}
                                    </div>
                                ...
                                <div class="form-group">
                                    <label class="required" for="mobile">الجوال</label>
                                    <input class="form-control {{ $errors->has('mobile') ? 'is-invalid' : '' }}"
                                        type="text" name="mobile" id="mobile" value="" required>
                                    @if($errors->has('mobile'))
                                    <div class="invalid-feedback">
                                        {{ $errors->first('mobile') }}
                                    </div>
...
إضافة العناوين
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                class="form-control pl-0 pb-0 pt-0{{ $errors->has('address_3') ? 'is-invalid' : '' }}"
                                                type="text" name="address_3" id="address_3"
                                                value="{{ old('address_3', '') }}">
                                            ...
                                            @endif
                                            <span
                                                class="help-block">{{ trans('cruds.client.fields.address_3_helper') }}</span>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-6 col-lg-6 col-sm-12">
                                                <label>المنطقة</label>
                    ...
                    <div class="wizard wizard-3" id="kt_wizard_v3" data-wizard-state="step-first"
                        ...
                        <div class="row justify-content-center py-10 px-8 py-lg-12 px-lg-10">
                            ...
                            <div class="modal-footer d-flex justify-content-between border-top mt-10 pt-20">
                                <div class="mr-2">
                                    <button type="button"
...
<script>
    ...
    url: '{{ route('admin.clients.storeMedia') }}',
        ...
        _results = []
        for (_i = 0, _len = _ref.length; _i < _len; _i++) { node=_ref[_i] _results.push(node.textContent=message) }

...
{{-- @can('report_type_create') --}}
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'ReportType', 'route' => 'admin.report-types.parseCsvImport'])
        </div>
    </div>
{{-- @endcan --}}
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-ReportType">
            <thead>
                <tr>
                    <th width="10">
...
{{--                        <input class="search" type="text" placeholder="{{ trans('global.search') }}">--}}
                    ...
                    <td>
                        <select class="search" strict="true">
                            ...
                            @foreach(App\Models\ReportType::STATUS_SELECT as $key => $item)
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.report-types.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-ReportType').DataTable(dtOverrideGlobals);

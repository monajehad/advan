      ...
      <table class="table table-bordered " id="kt-table">
          <thead class="datatable-head">
              <tr class="text-center">
                  <th>#</th>
                  <th class="datatable-cell datatable-cell-sort">الاسم بالكامل</th>
                  <th>اسم المستخدم</th>
          ...
          <tbody class="text-center font-size-sm">
              ...
              <tr class="data-row">
                  ...
                  {{-- @can('users-update') --}}
                  <td>
                      <a class=" edit-employee" data-employee-id="{{$employee->id}}">
                  ...
                  {{-- @can('users-delete') --}}
                  <td>
                      <button class=" btn-icon    delete-user" data-employee-id="{{$employee->id}}">
                          <span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg"
                                  xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                  viewBox="0 0 24 24" version="1.1">
                                  <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">

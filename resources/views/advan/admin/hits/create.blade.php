...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.hit.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.hits.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('visit_type') ? 'is-invalid' : '' }}" name="visit_type_id" id="visit_type_id" required>
                    @foreach($visit_types as $id => $entry)
                        <option value="{{ $id }}" {{ old('visit_type_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_visit') ? 'is-invalid' : '' }}" type="text" name="duration_visit" id="duration_visit" value="{{ old('duration_visit', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('number_samples') ? 'is-invalid' : '' }}" type="text" name="number_samples" id="number_samples" value="{{ old('number_samples', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('report_type') ? 'is-invalid' : '' }}" type="text" name="report_type" id="report_type" value="{{ old('report_type', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('report_status') ? 'is-invalid' : '' }}" type="text" name="report_status" id="report_status" value="{{ old('report_status', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('sms') ? 'is-invalid' : '' }}" name="sms_id" id="sms_id">
                    @foreach($sms as $id => $entry)
                        <option value="{{ $id }}" {{ old('sms_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('sms'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('sms_message') ? 'is-invalid' : '' }}" name="sms_message" id="sms_message">{{ old('sms_message') }}</textarea>

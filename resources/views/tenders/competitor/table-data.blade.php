...
<!--begin::Table-->
<div class="table-responsive datatable datatable-bordered datatable-head-custom datatable-default  table-striped table-hover   datatable-primary datatable-loaded">
<table class="table table-bordered " id="items-table">
    ...
    <tbody class="text-center font-size-sm">
        ...
        <tr class="data-row">
            ...
            <td>
                <button class="edit-competitor" data-competitor-id="{{$competitor->id}}">
           ...
           {{-- @can('competitors-delete') --}}
            <td>
                <button class=" btn-icon delete-competitor" data-competitor-id="{{$competitor->id}}">
                    <span class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                            viewBox="0 0 24 24" version="1.1">
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        @empty
        <tr>
            <td class="text-muted text-center font-size-lg" colspan="10">لا يوجد منافسين</td>
        </tr>
        @endforelse
    </tbody>
</table>

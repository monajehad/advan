...
.header .navbar .nav-item .toggle-body {
    ...
    box-shadow: 0px 40px 64px -12px rgb(0 0 0 / 8%), 0px 0px 14px -4px rgb(0 0 0 / 5%), 0px 32px 48px -8px rgb(0 0 0 / 10%);
}
</style>

<div id="kt_header" class="header header-fixed">
    <header class="d-flex align-items-center justify-content-between px-xl-7 px-5 py-5">
        <div class="search-header ">
          ...
          <div class="search-input input-group">
            ...
            <input class="form-control rounded-2" type="text" placeholder="البحث" aria-describedby="search-input">
            ...
            <div class="group">
              ...
              <div class="list mb-4">
                <div class="item d-flex py-3"><a class="link d-flex align-items-center flex-fill">
                    <div class="thumb"><img srcset="img/content/image-05@2x.jpg 2x" src="img/content/image-05.jpg" alt="Put your title here">
                    </div>
        ...
        <div class="navbar">
          ...
          <div class="nav-item messages-item toggle-item">
            <button class="toggle-head nav-link active">
             <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\Communication\Chat5.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <path d="M7.5,12 C6.67157288,12 6,11.3284271 6,10.5 C6,9.67157288 6.67157288,9 7.5,9 C8.32842712,9 9,9.67157288 9,10.5 C9,11.3284271 8.32842712,12 7.5,12 Z M12.5,12 C11.6715729,12 11,11.3284271 11,10.5 C11,9.67157288 11.6715729,9 12.5,9 C13.3284271,9 14,9.67157288 14,10.5 C14,11.3284271 13.3284271,12 12.5,12 Z M17.5,12 C16.6715729,12 16,11.3284271 16,10.5 C16,9.67157288 16.6715729,9 17.5,9 C18.3284271,9 19,9.67157288 19,10.5 C19,11.3284271 18.3284271,12 17.5,12 Z" fill="#000000" opacity="0.3"/>
          ...
          <div class="nav-item notification-item toggle-item">
            <button class="toggle-head nav-link active">
             <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\General\Notifications1.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#000000" opacity="0.3" x="10" y="16" width="4" height="4" rx="2"/>
          ...
          <div class="nav-item user-item toggle-item">
            <div class="toggle-head nav-link"><img src="{{asset("assets/images/user-1.jpg")}}"></div>
            <div class="toggle-body">

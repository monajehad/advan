<ul class="menu-nav">
    <li class="menu-item menu-item-active" aria-haspopup="true">
        <a href="index.html" class="menu-link">
            ...
            <span class="menu-text">الشركة المتطورة</span>
        </a>
    </li>
    ...
    <li class="menu-item " aria-haspopup="true" data-menu-toggle="hover">
        <a href="{{route('admin.samples.index')}}" class="menu-link menu-toggle">
        <span class="svg-icon menu-icon">
...
<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    <a href="javascript:;" class="menu-link menu-toggle">
        ...
        <span class="menu-text">العينات</span>
        <i class="menu-arrow"></i>
    </a>
    <div class="menu-submenu" kt-hidden-height="400" style="display: none; overflow: hidden;">
        <i class="menu-arrow"></i>
        <ul class="menu-subnav">
            <li class="menu-item" aria-haspopup="true">
                <a href="{{route('admin.sample-stocks.index')}}" class="menu-link">
                    ...
                    <span class="menu-text">مخزون العينات</span>
        ...
        <ul class="menu-subnav">
            ...
            <li class="menu-item" aria-haspopup="true">
                <a href="{{route('admin.hits.note')}}" class="menu-link">
                    ...
                    <span class="menu-text"> الملاحظات</span>
            ...
            <li class="menu-item" aria-haspopup="true">
                <a href="{{route('admin.hits.hitsMap')}}" class="menu-link">
                    ...
                    <span class="menu-text"> خريطة الزيارات اليومية</span>
...
<!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\legacy\metronic\theme\html\demo1\dist/../src/media/svg/icons\Home\Book-open.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
     <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <span class="menu-text">المناقصات  </span>
<!-- <i class="menu-arrow"></i> -->
    </a>
</li>
<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    <a href="javascript:;" class="menu-link menu-toggle">
        ...
        <span class="menu-text">الاشخاص</span>
        <i class="menu-arrow"></i>
    </a>
    <div class="menu-submenu" kt-hidden-height="400" style="display: none; overflow: hidden;">
        <i class="menu-arrow"></i>

                    ...
                    <div class="card mb-2 p-4 p-sm-5">
                        ...
                        <div class="card-body p-0" dir="rtl">
                            <div class="stock-list row gx-4 flex-nowrap">
                                <div
                                    class="stock-item stock-green col p-6 mx-2 flex-shrink-0 flex-grow-1 sheet-table-item d-flex align-items-start ">
                                    ...
                                    <div class="d-flex ">
                                        <div class="stock-details">
                                            <div class="stock-caption caption d-flex align-items-center mb-1">
                                                <div class="info-tooltip ps-1 pe-2 text-gray-600"
                                                    data-bs-toggle="tooltip" title="Small description">اجمالي العملاء
                                ...
                                <div
                                    class="stock-item stock-purple  col p-6 mx-2 flex-shrink-0 flex-grow-1 sheet-table-item d-flex align-items-start ">
                                    <div class="stock-icon p-3 rounded-circle d-inline-block mb-4">
                                        <svg class="icon icon-activity">
                                            <use xlink:href="#icon-activity"></use>
                                        </svg>
                                ...
                                <div
                                    class="stock-item stock-blue col p-6 mx-2 flex-shrink-0 flex-grow-1 sheet-table-item d-flex align-items-start ">
                                    <div class="stock-icon p-3 rounded-circle d-inline-block mb-4">
                                        <svg class="icon icon-activity">
                                            <use xlink:href="#icon-activity"></use>
                                        </svg>
                            ...
                            <div class="stock-list mt-10 row gx-4 flex-nowrap">
                                <div
                                    class="stock-item stock-green  p-6 mx-2 flex-shrink-0  sheet-table-item d-flex align-items-start ">
                                    <div class="stock-icon p-3 rounded-circle d-inline-block mb-4">
                                        <svg class="icon icon-activity">
                                            <use xlink:href="#icon-activity"></use>
                                        </svg>
        ...
        <div
            ...
            <div class="title title-color purple me-5 mb-4 mb-sm-0 d-flex">
                ...
                <div class="nav row gx-4 ms-sm-auto flex-nowrap d-flex mb-4 mb-sm-0 align-self-stretch">
                    ...
                    <div class="btn-tab btn-small col " data-bs-target="#tab-traffic" data-bs-toggle="tab">
                        <h4>العينات</h4>
                    </div>
                </div>
            ...
            <div class=" d-flex ">
                <div class="card-toolbar">
                    <a href="/metronic8/demo1/../demo1/pages/social/activity.html" class="btn btn-sm btn-light"> مشاهدة
                        الكل</a>
                </div>
            ...
            <div class="row g-0 pb-5 tab-pane fade active show" id="tab-products" role="tabpanel">
                <div class="sheet-table d-table ">
                    ...
                    <div class="d-table-row grid-markup">
                        ...
                        <div class="sheet-cell d-table-cell py-3 px-5 text-shades-2 text-base-2 text-nowrap">Oct 2021
                        </div>

...
(function () {
  var options = {
    ...
    xaxis: {
      type: "category",
      categories: ["يناير", " فبراير", " مارس", "ابريل ", "مايو ", " يونيو", " يوليو" ,"اغسطس" ,"سبتمبر","أكتوبر","نوفمبر","ديسمبر"],
      axisBorder: {
        show: false
      },
      axisTicks: {
...
(function () {
  ...
  var chart = document.querySelector(".chart-top-device");
...
(function () {
  var options = _defineProperty({
    ...
    colors: ["#2A85FF", "#FFBC99", "#B1E5FC", "#CABDFF"],
    dataLabels: {
      enabled: false
    },
    xaxis: {
...
( function () {
  ...
  var chart = document.querySelector("#chart_3");
